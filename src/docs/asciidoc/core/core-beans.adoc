...
* <<beans-java, Java-based configuration>>: Starting with Spring 3.0, many features
  provided by the Spring com.agx.JavaConfig project became part of the core Spring Framework.
...
It is worth pointing out that through its <<beans-java, com.agx.JavaConfig>> option, Spring lets
...
NOTE: When configuring a `PropertySourcesPlaceholderConfigurer` using com.agx.JavaConfig, the
...
[NOTE]
====
Starting with Spring 3.0, many features provided by the Spring com.agx.JavaConfig project are
