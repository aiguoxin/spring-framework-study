...
----
	@RequestMapping("/")
	public String handle(@SessionAttribute com.agx.User user) { <1>
		// ...
	}
----
...
----
	@RequestMapping("/")
	fun handle(@SessionAttribute user: com.agx.User): String { // <1>
		// ...
	}
----
...
----
	...
	public class UserController {
		...
		@GetMapping("/user")
		@JsonView(com.agx.User.WithoutPasswordView.class)
		public com.agx.User getUser() {
			return new com.agx.User("eric", "7!jd#h23");
		}
	}

	public class com.agx.User {
		...
		public com.agx.User(String username, String password) {
...
----
	...
	class UserController {
		...
		@GetMapping("/user")
		@JsonView(com.agx.User.WithoutPasswordView::class)
		fun getUser() = com.agx.User("eric", "7!jd#h23")
	}
...
----
	...
	public class UserController extends AbstractController {
		...
		public String getUser(Model model) {
			model.addAttribute("user", new com.agx.User("eric", "7!jd#h23"));
			model.addAttribute(JsonView.class.getName(), com.agx.User.WithoutPasswordView.class);
			return "userView";
		}
	}
----
...
----
	...
	class UserController : AbstractController() {
		...
		fun getUser(model: Model): String {
			model["user"] = com.agx.User("eric", "7!jd#h23")
			model[JsonView::class.qualifiedName] = com.agx.User.WithoutPasswordView::class.java
			return "userView"
		}
	}
----
